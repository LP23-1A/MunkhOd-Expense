export default function Card2() {
  return (
    <main>
      <div className="h-[219.659px] w-[384.124px] rounded-[18px] bg-white">
        <div className="flex items-center gap-[8px] px-[24px] py-[16px] ">
          ...
          <h1 className="text-[16px] font-semibold">Your Income</h1>
        </div>
        <div className="flex flex-col px-[24px] py-[20px] gap-4">
